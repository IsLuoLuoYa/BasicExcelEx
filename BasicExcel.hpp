...
public: // File functions.
	...
	bool Load(const char* filename, bool IsOnlyRead = false);		///< Load an Excel workbook from a file.
	bool Load(const wchar_t* filename, bool IsOnlyRead = false);	///< Load an Excel workbook from a file.
...
public:
	...
	void SetInt32(int val);			///< Set content of current Excel cell to an integer.
...
private:
	int type_ = 0;				///< Type of value stored in current Excel cell. Contains one of the above enums.
	int ValInt32_ = 0;				///< Integer value stored in current Excel cell1.
	int64_t ValInt64_ = 0;
	double ValDouble_ = 0;			///< Double value stored in current Excel cell.
	std::string VarStr_;		///< ANSI string stored in current Excel cell. Include null character.
	std::wstring ValWStr_;	///< Unicode string stored in current Excel cell. Include null character.
};
